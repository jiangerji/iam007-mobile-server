...
def main():
    ...
    createCommand = 'create table if not exists `plugins_android` (`id` char(20) not null, `name` text not null, `description` text null, `icon` text not null, `url` text not null, `md5_value` text not null, `force_update` int null default 0, `version` text null, `type` int null default 0, `state` int null default 1);'
